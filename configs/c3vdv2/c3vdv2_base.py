...
config = dict(
    ...
    depth = dict(
        ...
        deforms = dict(
            ...
            nr_basis = 48,              # leaner basis for 50-frame slice
            use_xyzt = True,
            xyzt_init_sigma = max(5, int(0.3 * frames)),
            use_distributed_biases = True,
            xyzt_gate_thresh = 0.005,
    ...
    tracking=dict(
        ...
        lrs=dict(
            ...
            cv_vel_xyz = 0.00025,
            cv_vel_log_scales = 0.00007,
            cv_angvel_aa = 0.00008,
            feature_rest = 0.00002,
            t_mu = 5e-6,
            t_logvar = 5e-6
        ),
    ),
