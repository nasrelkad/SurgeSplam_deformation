...
srun apptainer exec --nv --bind /scratch-shared/hhuitema:/scratch-shared/hhuitema /home/hhuitema/docker/endogslam_v2.sif            torchrun --nnodes 1 --nproc_per_node 1 train_GRN.py \
