...
class HamlynDataset(GradSLAMDataset):
    def __init__(
        self,        
        config_dict,
        basedir,
        ...
        desired_height: Optional[int] = 336,
        desired_width: Optional[int] = 336,
    ...
    def get_filepaths(self):
        color_paths = natsorted(glob.glob(f"{self.input_folder}/image01/*.jpg"))
        depth_paths = natsorted(glob.glob(f"{self.input_folder}/depth01/*.png"))
